...
SLEEP:
	...
	;INIT TAKES 7 CYCLES
	;LOOP ITERATION TAKES 61+SLEEP$STEP
...
SLEEP$LOOP:
	...
	CALL	SLEEP$STEP	;SLEEP FOR ROUGHLY 1 MS (BIT UNDER)

	MOV	A,E		;RESTORE ITERATOR TO REG ACC

	INR	A		;INCREMENT TO NEXT VALUE
	JMP	SLEEP$LOOP	;LOOP FOR NEXT 1MS WAIT
...
SLEEP$STEP:
	...
	;TRASH NOP INSTRUCTIONS FOR TIMING (17 CYCLES)
	MOV	A,A		;5
	NOP			;4
	NOP			;4
	NOP			;4
